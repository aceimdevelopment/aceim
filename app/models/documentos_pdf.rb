...
#    pdf.add_text 70,698,to_utf16("Administrador de Cursos de Extensión de Idiomas Modernos"),7
  ...
  def self.factura(factura)
    ...
    datos << { "nombre" => to_utf16("<i>#{factura.cliente.telefono_fijo.to_s.rjust(20,'.')}</i><i>#{factura.cliente.telefono_movil.rjust(25, '.')}</i>"), "valor" => "<i>#{factura.cliente.rif.to_s.ljust(12)}</i>" }
