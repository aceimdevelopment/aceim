...
task :apertura_nuevos => :environment do
  while !((DateTime.now.year.eql? 2014) and (DateTime.now.month.eql? 10) and (DateTime.now.day.eql? 8) and (DateTime.now.hour.eql? 22) and (DateTime.now.minute.eql? 5) ) do
